    ...
    <div>
      {session ? (
        ...
        <>
          ...
          <button
            className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-white border border-gray-300 text-gray-800 hover:bg-gray-100 hover:shadow-md transition duration-200"
